# Working with Wavlin as an AI agent

Wavlin is a 3rd party YouTube Music client written in Kotlin. It follows material 3 design guidelines closely.
...
3. All string edits should be made to the `Wavlin/app/src/main/res/values/wavlin_strings.xml` file, NOT `Wavlin/app/src/main/res/values/strings.xml`. Do not touch other `strings.xml` or `wavlin_strings.xml` files in the project. ONLY edit the default (English) `wavlin_strings.xml` file, DO NOT EDIT OTHER LANGUAGES.
