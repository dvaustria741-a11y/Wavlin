...
val baseApplicationId = "com.wavlin.music"
val applicationIdOverride = System.getenv("WAVLIN_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("WAVLIN_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("WAVLIN_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("WAVLIN_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("WAVLIN_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("WAVLIN_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        versionCode = 150
        versionName = "13.6.1"
        resValue("string", "app_name", appNameOverride ?: "Wavlin")
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Wavlin Debug")
            }
            signingConfig =
