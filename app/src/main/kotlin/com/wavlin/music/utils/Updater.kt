...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/dvaustria741-a11y/Wavlin"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "Wavlin.apk" -> "universal" to "foss"
                name == "Wavlin-with-Google-Cast.apk" -> "universal" to "gms"
