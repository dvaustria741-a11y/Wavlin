...
import com.wavlin.music.constants.ContentCountryKey
import com.wavlin.music.constants.ContentLanguageKey
import com.wavlin.music.constants.CountryCodeToName
import com.wavlin.music.constants.EnableBetterLyricsKey
import com.wavlin.music.constants.EnableKugouKey
import com.wavlin.music.constants.EnableLrcLibKey
import com.wavlin.music.constants.EnablePaxsenixKey
import com.wavlin.music.constants.EnableLyricsPlus
import com.wavlin.music.constants.HideExplicitKey
import com.wavlin.music.constants.HideVideoSongsKey
import com.wavlin.music.constants.HideYoutubeShortsKey
import com.wavlin.music.constants.LanguageCodeToName
import com.wavlin.music.constants.LyricsProviderOrderKey
import com.wavlin.music.constants.ProxyEnabledKey
import com.wavlin.music.constants.ProxyPasswordKey
import com.wavlin.music.constants.ProxyTypeKey
import com.wavlin.music.constants.ProxyUrlKey
import com.wavlin.music.constants.ProxyUsernameKey
import com.wavlin.music.constants.QuickPicks
import com.wavlin.music.constants.QuickPicksKey
import com.wavlin.music.constants.RandomizeHomeOrderKey
import com.wavlin.music.constants.SYSTEM_DEFAULT
import com.wavlin.music.constants.ShowArtistDescriptionKey
import com.wavlin.music.constants.ShowMostStatsPlaylistsKey
import com.wavlin.music.constants.ShowArtistSubscriberCountKey
import com.wavlin.music.constants.ShowMonthlyListenersKey
import com.wavlin.music.constants.ShowWrappedCardKey
import com.wavlin.music.constants.TopSize
...
import com.wavlin.music.ui.component.DraggableLyricsProviderItem
import com.wavlin.music.ui.component.DraggableLyricsProviderList
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.wavlin.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.wavlin.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.wavlin.music.db.entities.PlaylistEntity(
                        id = com.wavlin.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.wavlin.music.db.entities.PlaylistEntity(
                        id = com.wavlin.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
