package com.wavlin.paxsenix

import android.content.Context
import com.wavlin.music.betterlyrics.TTMLParser
import com.wavlin.paxsenix.models.AppleMusicSearchResponse
import com.wavlin.paxsenix.models.LyricsResponse

import com.wavlin.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Wavlin/$appVersion")
                }
