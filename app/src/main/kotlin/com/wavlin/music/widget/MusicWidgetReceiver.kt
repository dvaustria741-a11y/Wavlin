...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.wavlin.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.wavlin.music.widget.LIKE"
        const val ACTION_NEXT = "com.wavlin.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.wavlin.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.wavlin.music.widget.UPDATE_WIDGET"
    }
}
