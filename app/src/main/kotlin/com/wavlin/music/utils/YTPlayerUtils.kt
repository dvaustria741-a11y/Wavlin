...
import com.wavlin.innertube.NewPipeExtractor
...
import com.wavlin.innertube.strategy.ContentAwareFallbackStrategy
import com.wavlin.innertube.strategy.ContentHints
import com.wavlin.music.constants.AudioQuality
import com.wavlin.music.utils.YTPlayerUtils.MAIN_CLIENT
import com.wavlin.music.utils.YTPlayerUtils.validateStatus
import com.wavlin.music.utils.cipher.CipherDeobfuscator
import com.wavlin.music.utils.cipher.FunctionNameExtractor
import com.wavlin.music.utils.cipher.PlayerJsFetcher
import com.wavlin.music.utils.potoken.PoTokenGenerator
import com.wavlin.music.utils.potoken.PoTokenResult
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        if (streamPlayerResponse.playabilityStatus.status != "OK") {
            ...
            // unavailable streams; Wavlin cannot recover those without official playback.
