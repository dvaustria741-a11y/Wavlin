...
import com.wavlin.music.constants.AndroidAutoSectionsOrderKey
import com.wavlin.music.constants.AndroidAutoYouTubePlaylistsKey
import com.wavlin.music.ui.screens.settings.AndroidAutoSection
import com.wavlin.music.ui.screens.settings.deserializeSections
import com.wavlin.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.wavlin.innertube.pages.HomePage.Section>()
